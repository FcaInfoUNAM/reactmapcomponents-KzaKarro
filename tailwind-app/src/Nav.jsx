...
//Lo que hace "map" es iterar en cada elemento del array navigation y convertirlo usando lo definido en la función anonima de callback con "e"
//y al final convierte cada elemento del array en un enlace <li></li>
