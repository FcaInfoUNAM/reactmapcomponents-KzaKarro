...
function App() {
  ...
  return (
    ...
    <div className="bg-orange-500 p-8 grid grid-cols-4 gap-4">
      <div>
        <Card title="Nintendo switch 2" paragraph="sobrevaloradisimaaa consola que cuesta lo mismo que un comedor para 4 personas, una laptop gamer de entrada, un viaje a cancún una tv de 70 pulgadas o un diplomado de titulación"/>
        <img src="https://static0.gamerantimages.com/wordpress/wp-content/uploads/2025/01/nintendo-switch-2-tag-page-cover-art_upscayl_1x_ultramix_balanced-1.jpg" alt="" />
        {products.map(e=>
          <><Card title={e.name} paragraph={e.properties} /><img src={e.b64Image} alt={e.model} /></>
        )}
      </div>
    </div>
    </>
